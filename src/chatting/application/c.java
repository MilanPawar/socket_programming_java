...
public class c extends JFrame implements ActionListener {
   boolean  a=true;
    ...
    public c() {
        ...
        run.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, ActionEvent.CTRL_MASK));
        run.addActionListener(this);
        
        JMenuItem sync = new JMenuItem("Sync-Collab");
        sync.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, ActionEvent.CTRL_MASK));
...
//            int actionDialog = SaveAs.showOpenDialog(this);
            if(a)
            	//actionDialog != JFileChooser.APPROVE_OPTION) {
            {//new c();
               new Client();
            	return;
            }
